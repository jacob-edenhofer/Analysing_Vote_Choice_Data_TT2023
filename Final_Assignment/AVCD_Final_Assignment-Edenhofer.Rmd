...
heu <- read_dta(paste0(here(), "/Data/harmonised_EB_2004-2021_v3-0-0.dta"))
```
...
Who punished the CDU/CSU because of Laschet? (Lachet and so on)
-> Those who are struggling / hard times. 

-> egoistic vs sociotropic motivations/evaluations? 
-> egoistic evaluations matter more when one is ideologically closer to a candidate/party; spell this out
...
**Distinguish between voting for and having switched to.**
...
```{r}
heu1 <- heu %>%
  select(1:100, valpri1, valpri2, issue_14) 
# per year and country 
heu1 %>%
  count(country, year, p_13) %>% # 13 and 57
