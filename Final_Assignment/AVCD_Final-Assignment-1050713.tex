...
semi-loyalty or disloyalty to the system means that voting for them
increases the likelihood that the political system, characterised by the
mainstream cartel (\protect\hyperlink{ref-katz_cartel_2009}{Katz and
Mair 2009}), will be disrupted.
...
concerns the probability of voting AfD, relative to the
...
Wößmann 2020}). Letting \(\textbf{X}\) denote this vector and
...
The coefficient estimates on the interaction terms are, except for for
one, statistically insignificant, suggesting that it is \emph{not} the
case that the marginal effect of insecurity varies by the political
system's responsiveness or respondents' trust in parliament. This
conclusion is reinforced by figures 2 and 3 in the
