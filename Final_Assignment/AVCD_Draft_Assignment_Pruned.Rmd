...
Figure 1 visualises^[See the appendix for the full regression tables.] the results from running the regressions. 
...
g1 <- modelplot(list(afd_diff_gov_int11, afd_diff_gov_int5,
          ...
          coef_map = c("job_loss_year_next2yrs" = "Fear of job loss",
                          ...
                          "difference_who_votes" = "Difference which\nparty one votes for",
                          "difference_whos_gov" = "Difference which\nparty governs",
                          "difference_who_votes:job_loss_year_next2yrs" = "Difference which\nparty one votes for\nx Fear of job loss",
                          "difference_whos_gov:job_loss_year_next2yrs" = "Difference which\nparty governs\nx Fear of job loss",
                          "difference_who_votes:unemp_at_least_one_year_factor1" = "Difference which\nparty one votes for\nx Unemployment",
                          "difference_whos_gov:unemp_at_least_one_year_factor1" = "Difference which\nparty governs\nx Unemployment")) +
...
together +
  plot_annotation(title = "Coefficient plots of independent variables of interest",
                  ...
                  theme = theme(plot.title = element_text(size = 13, hjust = 0.5),
                                 plot.caption = element_text(size = 7.5, hjust = 1, face = "italic")))
```
...
## difference gov
### job loss fear 
afd_diff_gov_int111 <- glm(afd_21 ~ difference_whos_gov*job_loss_year_next2yrs + household_income + age + abitur_factor + sex1 + urban_rural_factor + ostwest_factor, 
                         family = binomial(link = "logit"), 
                         data = gles_mod)
afd_diff_gov_int111 <- glm(afd_21 ~ difference_whos_gov_factor*job_loss_year_next2yrs_factor + household_income + age + abitur_factor + sex1 + urban_rural_factor + ostwest_factor, 
                         family = binomial(link = "logit"), 
                         data = gles_mod)

### profession loss fear
afd_diff_gov_int21 <- glm(afd_21 ~ difference_whos_gov*profession_loss_next2yrs + household_income + age + abitur_factor + sex1 + urban_rural_factor + ostwest_factor, 
                         family = binomial(link = "logit"), 
                         data = gles_mod)
### unemployment experience
afd_diff_gov_int311 <- glm(afd_21 ~ difference_whos_gov*unemp_at_least_one_year + household_income + age + abitur_factor + sex1 + urban_rural_factor + ostwest_factor, 
                         family = binomial(link = "logit"), 
                         data = gles_mod)
afd_diff_gov_int3111 <- glm(afd_21 ~ difference_whos_gov_factor*unemp_at_least_one_year_factor + household_income + age + abitur_factor + sex1 + urban_rural_factor + ostwest_factor, 
                         family = binomial(link = "logit"), 
                         data = gles_mod)
