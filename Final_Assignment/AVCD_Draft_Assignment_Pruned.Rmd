...
```{r regression-results1-plot, fig.cap="Summary of tests for H1 - H3", fig.pos="!h"}
...
```{r multinomial-model-plot, fig.cap="Coefficient estimate of economic insecurity from multinomial model", fig.pos="!h"}
