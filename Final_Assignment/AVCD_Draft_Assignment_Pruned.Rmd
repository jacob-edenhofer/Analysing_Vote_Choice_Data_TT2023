...
[Figure 1](#fig:regression-results1-plot) visualises^[See the [appendix](#appendix) for the full regression tables, including coefficient estimates for the covariates.] the results from estimating these specifications. 
...
together +
  plot_annotation(title = "Coefficient plots of independent variables of interest",
                  ...
                  theme = theme(plot.title = element_text(size = 13, hjust = 0.5),
                                 plot.caption = element_text(size = 7.5, hjust = 1)))
```
...
\textcolor{red}{ME or predicted probability plot here.}
...
```{r regression-results1-robustness2}
