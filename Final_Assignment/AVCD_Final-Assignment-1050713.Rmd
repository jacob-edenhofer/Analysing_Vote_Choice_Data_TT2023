...
Figure 2 shows the coefficient estimates^[See table 4 in [appendix](#appendix) for the full regression table.] for $\beta_{1}$ - none of which are statistically significant at conventional levels.^[Conventional levels being the 1\%, 5\% and 10\% levels.] This entails, inter alia, that a unit-increase in economic insecurity does not significantly reduce the relative probability of voting for pro-redistributive, left-wing parties, here the SPD and Linke. Hence, we find no support for H4.
