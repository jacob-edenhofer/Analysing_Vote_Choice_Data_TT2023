...
probability that respondent \(i\) would vote for party \(j\), rather
than voting for the AfD. As explained above, H4 implies that
\(\beta_{1}\) should be negative for the SPD and LINKE. Figure 2 shows
the coefficient estimates\footnote{See table 4 in
